    ...
    <div className="max-w-xl mx-auto space-y-5 py-2">
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-xs text-gray-400 dark:text-gray-500 dark:text-gray-400">사용자명 (표시용)</p>
              {editingName ? (
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="p-1 text-gray-400 dark:text-gray-500 dark:text-gray-400 hover:text-primary-600 rounded transition-colors flex-shrink-0"
                    title="수정"
                  >
                    <Pencil size={13} />
                  </button>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-xs text-gray-400 dark:text-gray-500 dark:text-gray-400">아이디</p>
          ...
          <div className="flex items-start gap-3">
            <div className="w-9 h-9 flex-shrink-0" />
            <div>
              <p className="text-xs text-gray-400 dark:text-gray-500 dark:text-gray-400">가입일</p>
      ...
      <Section title="공유 설정">
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-800 dark:text-gray-200">운동 기록 공유</p>
              <p className="text-xs text-gray-400 dark:text-gray-500 dark:text-gray-400 mt-0.5">친구에게 내 운동 기록 공개</p>
            </div>
            <span
          ...
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-800 dark:text-gray-200">건강 기록 공유</p>
              <p className="text-xs text-gray-400 dark:text-gray-500 dark:text-gray-400 mt-0.5">친구에게 내 건강 기록 공개</p>
            </div>
            <span
              className={`inline-flex items-center gap-1 text-xs px-2.5 py-1 rounded-full font-medium ${
          ...
          <Link
            to="/friends"
            className="flex items-center justify-between mt-1 px-3 py-2 rounded-lg bg-gray-50 dark:bg-gray-900 hover:bg-primary-50 text-sm text-primary-600 font-medium transition-colors"
          >
      ...
      <Section title="비밀번호 변경">
        <form onSubmit={handlePwSubmit} className="space-y-3">
          <div>
            <label className="block text-xs font-medium text-gray-600 dark:text-gray-300 mb-1">현재 비밀번호</label>
            <Input
              type="password"
          ...
          <div>
            <label className="block text-xs font-medium text-gray-600 dark:text-gray-300 mb-1">새 비밀번호</label>
            <Input
              type="password"
              value={pwForm.next}
          ...
          <div>
            <label className="block text-xs font-medium text-gray-600 dark:text-gray-300 mb-1">새 비밀번호 확인</label>
            <Input
              type="password"
      ...
      <Section title="회원 탈퇴">
        {!showDeleteConfirm ? (
          <div className="flex items-center justify-between">
            <p className="text-sm text-gray-500 dark:text-gray-400">탈퇴 시 모든 기록이 영구적으로 삭제됩니다.</p>
            <Button
              type="button"
              variant="danger"
              size="sm"
